...
class PackageTests(unittest.TestCase):
    ...
    def test_config_is_consistent(self) -> None:
        ...
        self.assertTrue(CONFIG["space_repo"].endswith("-v3"))
        self.assertTrue(CONFIG["dataset_repo"].endswith("-v3"))
        self.assertTrue(CONFIG["output_repo"].endswith("-v3"))
    ...
    def test_checkpoint_and_state_are_one_commit(self) -> None:
        ...
        self.assertIn('primary_patterns.append("littlequeen-flux2-klein-v3.safetensors")', source)
