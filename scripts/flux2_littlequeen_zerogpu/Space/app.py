...
DATASET_REPO = os.environ.get("DATASET_REPO", "amazingfly/little-queen-flux2-klein-dataset-v1")
OUTPUT_REPO = os.environ.get("OUTPUT_REPO", "amazingfly/little-queen-flux2-klein-lora-v1")
TRIGGER = "LQK4N"
TOTAL_STEPS = int(os.environ.get("TOTAL_STEPS", "1600"))
...
WORK_ROOT = Path("/tmp/lq_flux2_training")
...
def upload_checkpoint(
    ...
    state = {
        "version": "little-queen-flux2-klein-training-v1",
        "updated_at": utc_now(),
    ...
    if complete:
        ...
        shutil.copy2(lora, OUTPUT_DIR / "littlequeen-flux2-klein-v1.safetensors")
        primary_patterns.append("littlequeen-flux2-klein-v1.safetensors")
    ...
    try:
        ...
        if lora.is_file() and step % 200 == 0:
            api.upload_file(
                repo_id=OUTPUT_REPO,
                repo_type="model",
                path_or_fileobj=lora,
                path_in_repo=f"checkpoints/littlequeen-flux2-klein-step{step:06d}.safetensors",
