...
DATASET_REPO = os.environ.get("DATASET_REPO", "amazingfly/little-queen-flux2-klein-dataset-v2")
OUTPUT_REPO = os.environ.get("OUTPUT_REPO", "amazingfly/little-queen-flux2-klein-lora-v2")
TRIGGER = "LQK4N"
...
WORK_ROOT = Path("/tmp/lq_flux2_training_v2")
...
def upload_checkpoint(
    ...
    state = {
        "version": "little-queen-flux2-klein-training-v2",
        "updated_at": utc_now(),
    ...
    if complete:
        ...
        shutil.copy2(lora, OUTPUT_DIR / "littlequeen-flux2-klein-v2.safetensors")
        primary_patterns.append("littlequeen-flux2-klein-v2.safetensors")
    ...
    try:
        ...
        if lora.is_file() and step % 200 == 0:
            api.upload_file(
                ...
                path_in_repo=f"checkpoints/littlequeen-flux2-klein-v2-step{step:06d}.safetensors",
