#!/usr/bin/env python3
"""Install a pinned kohya trainer and train the Little Queen SDXL LoRA on Colab."""
...
ROOT = Path("/content/lqxl")
BUNDLE = Path("/content/lqxl_bundle.tar.gz")
...
def main() -> int:
    ...
    final_lora = OUTPUT / "lqxl_sdxl_v1.safetensors"
